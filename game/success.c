...
/*   Updated: 2024/02/26 10:45:20 by amirloup         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_success(t_game *g)
{
	...
	if (mlx_resize_image(g->sprite.win1, g->p_size_x * 1.2, \
		g->p_size_y * 0.6) == false)
		exit((ft_printf("Error\nResizing image!\n"), d_a(g), EXIT_FAILURE));
	if (mlx_resize_image(g->sprite.win2, g->p_size_x * 1.2, \
		g->p_size_y * 0.6) == false)
		exit((ft_printf("Error\nResizing image!\n"), d_a(g), EXIT_FAILURE));
